...
/**
*/
class Music_pluginAudioProcessor  : public juce::AudioProcessor
...
public:
    //==============================================================================
    Music_pluginAudioProcessor();
    ~Music_pluginAudioProcessor() override;
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Music_pluginAudioProcessor)
};
